...
<head>
	...
	<link rel="stylesheet" href="<?php echo C('f-css')?>/login.css" type="text/css">
	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
			<div class="login_form fl">
				<form action="<?php echo U('Home/User/userCenter');?>" method="post">
					<ul>
						<li>
							<label for="">用户名：</label>
						...
						<li class="checkcode">
							...
							<img src="<?php echo C('f-img')?>/checkcode1.jpg" alt="" />
