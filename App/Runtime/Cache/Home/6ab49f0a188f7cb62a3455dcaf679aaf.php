...
<head>
	...
	<link rel="stylesheet" href="<?php echo C('f-css')?>/goods.css" type="text/css">
	<link rel="stylesheet" href="<?php echo C('f-css')?>/common.css" type="text/css">
	...
	<!--引入jqzoom css -->
	<link rel="stylesheet" href="<?php echo C('f-css')?>/jqzoom.css" type="text/css">
	...
	<script type="text/javascript" src="<?php echo C('f-js')?>/goods.js"></script>
	<script type="text/javascript" src="<?php echo C('f-js')?>/jqzoom-core.js"></script>
...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="/"><img src="<?php echo C('f-img')?>/logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('f-img')?>/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('f-img')?>/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('f-img')?>/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('f-img')?>/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="<?php echo C('f-img')?>/relate_view5.jpg" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo C('f-img')?>/preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo C('f-img')?>/preview_m1.jpg" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo C('f-img')?>/preview_m1.jpg',largeimage: '<?php echo C('f-img')?>/preview_l1.jpg'}"><img src="<?php echo C('f-img')?>/preview_s1.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo C('f-img')?>/preview_m2.jpg',largeimage: '<?php echo C('f-img')?>/preview_l2.jpg'}"><img src="<?php echo C('f-img')?>/preview_s2.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo C('f-img')?>/preview_m3.jpg',largeimage: '<?php echo C('f-img')?>/preview_l3.jpg'}">
	    							<img src="<?php echo C('f-img')?>/preview_s3.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo C('f-img')?>/preview_m4.jpg',largeimage: '<?php echo C('f-img')?>/preview_l4.jpg'}">
	    							<img src="<?php echo C('f-img')?>/preview_s4.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo C('f-img')?>/preview_m5.jpg',largeimage: '<?php echo C('f-img')?>/preview_l5.jpg'}">
	    							<img src="<?php echo C('f-img')?>/preview_s5.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo C('f-img')?>/preview_m6.jpg',largeimage: '<?php echo C('f-img')?>/preview_l6.jpg'}">
	    							<img src="<?php echo C('f-img')?>/preview_s6.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo C('f-img')?>/preview_m7.jpg',largeimage: '<?php echo C('f-img')?>/preview_l7.jpg'}">
	    							<img src="<?php echo C('f-img')?>/preview_s7.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo C('f-img')?>/preview_m8.jpg',largeimage: '<?php echo C('f-img')?>/preview_l8.jpg'}">
	    							<img src="<?php echo C('f-img')?>/preview_s8.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo C('f-img')?>/preview_m9.jpg',largeimage: '<?php echo C('f-img')?>/preview_l9.jpg'}">
	    							<img src="<?php echo C('f-img')?>/preview_s9.jpg"></a>
								</li>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="<?php echo U('Home/Cart/flow1');?>" method="post" class="choose">
						<ul>
							<li class="product">
								<dl>
									<dt>颜色：</dt>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						...
						<div class="desc mt10">
							...
							<img src="<?php echo C('f-img')?>/desc1.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('f-img')?>/desc2.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('f-img')?>/desc3.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('f-img')?>/desc4.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('f-img')?>/desc5.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('f-img')?>/desc6.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('f-img')?>/desc7.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('f-img')?>/desc8.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('f-img')?>/desc9.jpg" alt="" />
						</div>
					</div>
					<!-- 商品介绍 end -->
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="<?php echo C('f-img')?>/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="<?php echo C('f-img')?>/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="<?php echo C('f-img')?>/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
