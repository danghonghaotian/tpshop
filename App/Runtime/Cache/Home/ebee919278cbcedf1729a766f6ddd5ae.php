...
<body>
	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<tbody>
				<tr>
					<td class="col1"><a href=""><img src="<?php echo C('f-img');?>/cart_goods1.jpg" alt="" /></a>  <strong><a href="">【1111购物狂欢节】惠JackJones杰克琼斯纯羊毛菱形格</a></strong></td>
				...
				<tr>
					<td class="col1"><a href=""><img src="<?php echo C('f-img');?>/cart_goods2.jpg" alt="" /></a> <strong><a href="">九牧王王正品新款时尚休闲中长款茄克EK01357200</a></strong></td>
				...
				<tr>
					<td class="col1"><a href=""><img src="<?php echo C('f-img');?>/cart_goods3.jpg" alt="" /></a> <strong><a href="">【1111购物狂欢节】捷王纯手工缝制休闲男鞋大头皮鞋 头层牛</a></strong></td>
		...
		<div class="cart_btn w990 bc mt10">
			<a href="<?php echo U("Home/Cart/flow2");?>" class="continue">继续购物</a>
			<a href="<?php echo U("Home/Cart/flow2");?>" class="checkout">结 算</a>
		</div>
	</div>
	<!-- 主体部分 end -->
