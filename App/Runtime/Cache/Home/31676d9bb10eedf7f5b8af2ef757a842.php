...
<head>
	...
	<link rel="stylesheet" href="<?php echo C('f-css')?>/list.css" type="text/css">
	...
	<script type="text/javascript" src="<?php echo C('f-js')?>/list.js"></script>
</head>
<body>
	<!-- 顶部导航 start -->
	<div class="topnav">
			...
			<div class="newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('f-img')?>/list_hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('f-img')?>/list_hot2.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="<?php echo C('f-img')?>/list_hot3.jpg" alt="" /></a></dt>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					<li>
						<dl>
							<dt><a href="<?php echo U('Home/Goods/detail');?>"><img src="<?php echo C('f-img')?>/goods1.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('f-img')?>/goods2.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('f-img')?>/goods3.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('f-img')?>/goods4.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('f-img')?>/goods5.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('f-img')?>/goods6.jpg" alt="" /></a></dt>
