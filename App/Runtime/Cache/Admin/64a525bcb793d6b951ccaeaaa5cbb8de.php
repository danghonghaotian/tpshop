...
<head>
    <title><?php echo C('shopName');?> - 添加分类 </title>
...
<div class="main-div">
    <form method="post" action="<?php echo U("Admin/ArticleCat/add") ?>" >
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">文章分类名称</td>
                <td>
                    <input type="text" name="cat_name" maxlength="60" value="" size="30" />
            ...
            <tr>
                ...
                <td><input type="text" name="sort_order" value="50"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea  name="cat_desc" cols="60" rows="4"  ></textarea>
                </td>
            </tr>
