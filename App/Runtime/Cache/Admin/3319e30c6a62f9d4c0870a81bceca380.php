    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <tr>
                ...
                <td align="center">
                <a  onclick="return confirm('确定要删除吗');" href="<?php echo U("Admin/Sms/del",array("id"=>$sms["sms_id"]));?>" title="删除"><img src="<?php echo C('img');?>/no.gif" width="16" height="16" border="0" /></a>
                <a href="<?php echo U("Admin/Sms/save",array("id"=>$sms["sms_id"]));?>" title="编辑"><img src="<?php echo C('img');?>/icon_edit.gif" width="16" height="16" border="0" /></a>
                <a href="<?php echo U("Admin/Sms/trash",array("id"=>$sms["sms_id"]));?>" onclick="" title="回收站"><img src="<?php echo C('img');?>/icon_trash.gif" width="16" height="16" border="0" /></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
