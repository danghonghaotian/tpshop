...
<head>
    <title><?php echo C('shopName');?> - 添加会员等级 </title>
...
<div class="main-div">
    <form method="post" action="<?php echo U('Admin/UserRank/add');?>" >
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="low_num" maxlength="60" size="15" value="" />
                    <span class="require-field">*</span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="top_num" maxlength="60" size="15" value="" />
                    <span class="require-field">*</span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="rate" maxlength="40" size="15" />
                    <span class="require-field">*</span>
                </td>
            </tr>
            <tr>
