...
<div class="main-div">
    <form method="post" action="<?php echo U("Admin/Role/add") ?>">
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                <td class="label" style="font-weight: bold;color: red">
                    <input name="node_id[]" value="<?php echo $v['id'];?>" type="checkbox" /><?php echo $v['title']?></td>
                <td></td>
            </tr>
            <?php foreach ($v['child'] as $k1=>$v1):?>
            <tr>
                <td class="label">
                    <input name="node_id[]" value="<?php echo $v1['id'];?>" type="checkbox"><?php echo $v1['title']; ?> </td>
                <td>
                    <?php foreach ($v1['child'] as $k2=>$v2): ?>
                    <div style="width:200px;float:left;">
                        <label for="goods_manage"><input name="node_id[]" value="<?php echo $v2['id'];?>"  type="checkbox">
