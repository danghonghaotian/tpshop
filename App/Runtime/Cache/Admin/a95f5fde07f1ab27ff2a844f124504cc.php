...
<head>
    <title><?php echo C('shopName');?> - 修改商品类型 </title>
...
<div class="main-div">
    <form method="post" action="<?php echo U("Admin/GoodsType/save") ?>"enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">商品类型名称</td>
                <td>
                    <input type="text" name="type_name" maxlength="60" value="<?php echo $data['type_name'];?>" size="60" />
