...
/**************************请求参数**************************/
        ...
        //必填，不能修改
        //服务器异步通知页面路径
        $notify_url = "http://www.xxx.com/create_partner_trade_by_buyer-PHP-GBK/notify_url.php";
        //需http://格式的完整路径，不能加?id=123这类自定义参数
        //页面跳转同步通知页面路径
        $return_url = "http://www.xxx.com/create_partner_trade_by_buyer-PHP-GBK/return_url.php";
